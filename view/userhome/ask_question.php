            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="askQuestions">
                    ...
                    <div class="ask_question_header">
                        <h2 style="text-align: center">Ask a Question here</h2>
                    </div>
                    <div class="ask_question_body">
                        <form action="question_store.php" method="post">
                            <div class="field">
                                <label for="question_head">Title</label>
                                <input type="text" name="title" id="question_head" placeholder="Title"> <br><br>
                                <textarea id="question" rows="7" cols="50" name="question" placeholder="Description"></textarea><br>
